		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-3">
					<div class="logo"><a href="pagAdministrador.php"><img ID="iLogo" src="../IMAGENES/Logo.png"></a></div>
				</div>
				<div class="col-sm-6">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav">
                           <a class="nav-item nav-link" style="border-bottom: 5px solid #4bc714;" href="">Inicio</a>
