...
window.alert("BIENVENIDO A GESTIÓN DE USUARIOS");
	</script>
	<meta charset="UTF-8">
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-12 col-lg-3">
					<div class="logo"><a href="GestionSesion.php"><img ID="iLogo" src="../../IMAGENES/Logo.png"></a></div>
				</div>
				<div class="col-sm-6">
...
<div class="contenedorI">
	<div class="tablaG">
		<center><big><h1>Gestión de Usuarios</h1></big></center>
		...
		<table style="margin: 0 auto;" border="1" bordercolor="666633" cellpadding="2" cellspacing="2">
			...
			<?php foreach($resultado as $fila):?>
				<tr>
				    <td bgcolor="#EFF8FB"><?php echo $fila['Nombre']; ?></td>
				    <td bgcolor="#EFF8FB" ><?php echo $fila['PAterno']; ?></td>
				    <td bgcolor="#EFF8FB"><?php echo $fila['MAterno']; ?></td>
				    <td bgcolor="#EFF8FB"><?php echo $fila['Matricula']; ?></td>
					<td bgcolor="#EFF8FB"><?php echo $fila['NombreSesion']; ?></td>
					<td bgcolor="#EFF8FB"><?php echo $fila['correo']; ?></td>
                   <td bgcolor="#EFF8FB"><?php echo $fila['bloqueo']; ?></td>
