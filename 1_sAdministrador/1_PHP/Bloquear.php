...
//		echo "<script> alert('Llene el campo expediente ');</script>";
			//}else{
				$consulta_updateBloqueo=$con->prepare('UPDATE InicioSesion SET bloqueo=:bloqueo where=idSesion=:idSesion;');
...
<div class="btn__group">
				<a href="../0_Menu/GestionUsuarios.php" class="btn btn__danger" bgcolor="#BCF5A9">Cancelar</a>
