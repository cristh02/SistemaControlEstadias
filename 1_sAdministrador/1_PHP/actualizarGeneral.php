...
//		echo "<script> alert('Llene el campo expediente ');</script>";
			//}else{
				...
				$consulta_update->execute(array(
					...
					':Modalidad' =>$Modalidad,
					':Grupo'=>$Grupo,
					':id_Alumno_Expediente'=>$Liberacion,
					':Carrera' =>$Carrera,
                    ':Matricula' =>$Matricula,              
                	':NomCompleto' =>$NomCompleto,
                    ':Genero' =>$Genero,
	...
	<center><div class="form-group">
            ...
            <div class="form-group">
				...
				<!--<select type="text" name="Extencion" class="input__text">
                    /* falta la apertur de php
                    $con = new mysqli("localhost", "id16726646_informaionalumnos", "!yu?BTFx3SSeLxr/", "id16726646_informacionalumnos");
                    ...
                    $query = $con->prepare('SELECT * FROM DatoLugar');
                    $query->execute();
                    $data = $query->fetchAll();
                    foreach ($data as $valores):
                        echo '<option value="'.$valores["id_Lugar"].'">'.$valores["MunicipDeVeracruz"].'</option>';
                        endforeach;
				    ?>
                </select>-->
				<br><a>Modalidad</a><br>
				...
				<br><a>Grupo</a><br>
				<input type="text" name="Grupo" value="<?php if($resultado) echo $resultado['Grupo']; ?>" class="input__text">
				<br><a>Numero de expediente</a><br>
				<input type="text" name="id_Alumno_Expediente" value="<?php if($resultado) echo $resultado['id_Alumno_Expediente']; ?>" class="input__text" Grupo>
			</div>
            <div class="form-group">
				<a>Carrera</a><br>
			...
			<div>
				<br><a>Celular</a><br>
				<input type="text" maxlength="10" mimlength="10" name="Genero" value="<?php if($resultado) echo $resultado['Celular']; ?>" class="input__text">
				<br><a>Correo</a><br>
				<input type="text" name="Genero" value="<?php if($resultado) echo $resultado['correo']; ?>" class="input__text">
			</div>
			<div class="form-group">
				<a>Curp</a><br>
			...
			<div>
				...
				<input type="text" maxlength="2" name="PreRegistro" placeholder="Ejemplo '05-04-2021'" value="<?php if($resultado) echo $resultado['PreRegistro']; ?>"class="input__text" onkeyup="this.value=this.value.toUpperCase();">
			</div>
			<div>
				<a>Solicitud de estadía</a><br>
				<input type="text" maxlength="2" name="SoliciEstadia" placeholder="Ejemplo '05-04-2021'" value="<?php if($resultado) echo $resultado['SoliciEstadia']; ?>"class="input__text" onkeyup="this.value=this.value.toUpperCase();">
				<br><a>Consentimiento de Seguro</a><br>
				<input type="text" maxlength="2" name="ConsentSeguro" placeholder="Ejemplo '05-04-2021'" value="<?php if($resultado) echo $resultado['ConsentSeguro']; ?>" class="input__text" onkeyup="this.value=this.value.toUpperCase();">
			</div>
			<div>
				<a>Empresa</a><br>
				<input type="text" name="Empresa" placeholder="Ejemplo 'Gasera Cuxtlán S.A de S.V'" value="<?php if($resultado) echo $resultado['Empresa']; ?>" class="input__text">
				<br><a>Giro</a><br>
			...
			<div>
				...
				<input type="text" name="EstatusSE" value="<?php if($resultado) echo $resultado['EstatusSE']; ?>" class="input__text" onkeyup="this.value=this.value.toUpperCase();">
			</div>
