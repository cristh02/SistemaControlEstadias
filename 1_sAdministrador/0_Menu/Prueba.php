...
<HTML Lang="es">
    ...
    <!--datables CSS básico.   * Marca error-->
    <link type="text/css" href="datatables/datatables.min.css"/>
    <!--datatables estilo boostrap 4 CSS
    <link rel="stylesheet" type="text/css" href="DataTables-1.11.3/css/dataTables.bootstrap4.min.css"/>-->
    <link type="text/css" href="DataTables-1.11.3/css/dataTables.bootstrap5.min.css"/>
    <!--font awesome con CND-->
                             ...
                             <th>
                                ...
                                <select id="assigned-tutor-filter" id="buscacarrera" name="buscacarrera"
                                 class="form-control mt-2"style="border: #bababa 1px solid; color:#000000;" >
                                    ...
                                    <option value="<?php echo $_POST["buscacarrera"]; ?>"><?php echo $_POST["buscacarrera"]; ?></option><?php } ?>
                    ...
                    <thead>
                        <tr class="filters">
                            <th>Selecciona el orden
                                <select id="assigned-tutor-filter" id="orden" name="orden" class="form-control mt-2" style="border: #bababa 1px solid; color:#000000;" ><?php if ($_POST["orden"] != ''){ ?>
...
<tbody>
    ...
    <script src="DataTables/Buttons-1.5.6/js/dataTables.buttons.min.js"></script><!--Buscar carpeta--
    ...
    <script type="text/javascript" src="DataTables/Buttons-2.1.1/js/buttons.html5.min.js"></script>
    ...
    <script type="text/javascript" src="https://cdn.datatables.net/buttons/2.1.0/js/dataTables.buttons.min.js"></script><!--Error
